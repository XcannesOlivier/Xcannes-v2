...
export default function Home() {
  return (
    <>
      ...
      <h1 className="text-2xl sm:text-4xl md:text-5xl font-orbitron font-[500] mt-6 sm:mt-6  md:mt-6  pt-0 sm:pt-0 md:pt-0 flex items-center justify-center flex-wrap text-white ">
  Bienvenue sur
