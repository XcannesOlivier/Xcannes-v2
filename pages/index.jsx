...
export default function Home() {
  return (
    <>
      ...
      <h1 className="text-2xl sm:text-4xl md:text-5xl font-orbitron font-[500] -mt-[3rem] sm:-mt-[3rem]  md:-mt-[5rem]  flex items-center justify-center  text-white ">
  Bienvenue sur
  <span className="flex items-center -ml-3 -mt-12 sm:mt-0">
    <img
      src="/assets/img/ui/xcannesgreen.png"
      alt="Logo X"
      className="h-[12.5rem] sm:h-[16.2rem] md:h-[19rem] w-auto brightness-110 saturate-150  relative"
    />
  </span>
</h1>
