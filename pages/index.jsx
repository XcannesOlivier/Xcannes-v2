...
export default function Home() {
  return (
    <>
      ...
      <main className="flex flex-col items-center justify-center pt-18 sm:pt-28 md:pt-28 pb-5 px-4 text-center font-montserrat font-[300]">
      <h1 className="text-2xl sm:text-4xl md:text-5xl gap:2 font-orbitron font-[500] mb-6 sm:mb-6  md:mb-6  mt-1 sm:mt-0 md:mt-0 flex items-center justify-center flex-wrap text-white ">
  Bienvenue sur
  <span className="flex items-center ml-1 -mt-12 sm:mt-0">
    <img
      src="/assets/img/ui/xcannesgreen.png"
      alt="Logo X"
      className="h-[12.5rem] sm:h-[16.2rem] md:h-[19rem] w-auto max-w-full brightness-110 saturate-150 pt-[3rem] sm:pt-0 md:pt-0 mt-0 sm:mt-0 md:mt-0"
    />
  </span>
</h1>
