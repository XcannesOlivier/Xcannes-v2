  ...
  >
    ...
    ♦️Dragon<br />Casino♥️
            ...
            <div className="mt-6">
              <a
                href="/tokenomics"
                className="inline-block bg-xcannes-blue/40 text-white font-bold py-2 px-6 rounded-xl hover:bg-xcannes-blue/40 hover:text-white transition duration-300 transform hover:scale-105 hover:shadow-xl shadow-md"
              >
                📊 Tokenomics
              </a>
            </div>
