...
export default function FAQSection() {
  ...
  return (
    <section
      id="faq"
      className="relative faq-animate border border-white border-opacity-40 font-montserrat font-[300] w-full max-w-6xl mx-auto  text-white pb-20 px-6 mt-10 pt-0 rounded-3xl"
