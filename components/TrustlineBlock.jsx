...
export default function TrustlineBlock() {
  ...
  return (
    <section
      className="text-black bg-white/50 font-montserrat font-[300] border border-[2.5px] border-white shadow-2xl shadow-white/20b rounded-xl p-6 sm:p-8 my-10 max-w-3xl mx-auto"
