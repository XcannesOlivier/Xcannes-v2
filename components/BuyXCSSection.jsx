...
"
    ...
    CS ?
        ...
        <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 text-left">
          {/* Étape 1 */}
          <div className="bg-white  border-l-4 border-[#16b303] rounded-lg p-5 hover:shadow-xl transition hover:scale-[1.02] brightness-85 saturate-100 ">
  ...
  className="inline-block  text-sm font-[400] text-white  bg-[#16b303] px-4 py-2 rounded transition transform duration-300 hover:scale-105 brightness-85 saturate-100 "
>
  Installer le Wallet Xaman
          ...
          {/* Étape 2 */}
          <div className="bg-white shadow-md border-l-4 border-[#16b303] rounded-lg p-5 hover:shadow-xl transition hover:scale-[1.02] brightness-85 saturate-100">
...
>
  Ajouter la Trustline
          ...
          <div className="bg-white shadow-md border-l-4 border-[#16b303] rounded-lg p-5 hover:shadow-xl transition hover:scale-[1.02]brightness-85 saturate-100 ">
            ...
            <a
  href="/dex"
  className="text-sm font-[400] text-white bg-[#16b303] px-4 py-2 rounded transition transform duration-300 hover:scale-105 brightness-85 saturate-100 "
>
