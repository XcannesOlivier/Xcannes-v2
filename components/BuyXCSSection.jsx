...
"
    ...
    CS ?
        ...
        <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 text-left">
          {/* Étape 1 */}
          <div className="bg-white  border-l-4 border-[#16b303] rounded-lg p-5 hover:shadow-xl transition hover:scale-[1.02] brightness-95 saturate-100 ">
            <h3 className="text-lg sm:text-xl font-[400] mb-2">1. Installez un wallet XRPL</h3>
  ...
  className="inline-block  text-sm font-[400] text-white  bg-[#16b303] px-4 py-2 rounded transition transform duration-300 hover:scale-105 brightness-95 saturate-100 "
>
  Installer le Wallet Xaman
          ...
          {/* Étape 2 */}
          <div className="bg-white shadow-md border-l-4 border-[#16b303] rounded-lg p-5 hover:shadow-xl transition hover:scale-[1.02] brightness-95 saturate-100">
            <h3 className="text-lg sm:text-xl font-[400] mb-2">2. Ajoutez la Trustline</h3>
            <p className="mb-4 text-sm">
...
>
  Ajouter la Trustline
          ...
          {/* Étape 3 */}
          <div className="bg-white shadow-md border-l-4 border-[#16b303] rounded-lg p-5 hover:shadow-xl transition hover:scale-[1.02]brightness-95 saturate-100 ">
            <h3 className="text-lg sm:text-xl font-[400] mb-2">3. Achetez du XCS</h3>
            <p className="mb-4 text-sm">
            ...
            <a
  href="/dex"
  className="text-sm font-[400] text-white bg-[#16b303] px-4 py-2 rounded transition transform duration-300 hover:scale-105 brightness-95 saturate-100 "
>
