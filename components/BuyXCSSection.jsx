...
"
    ...
    CS ?
        ...
        <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 text-left">
          {/* Étape 1 */}
          <div className="bg-[#202320]/10 text-white border-l-4 border-[#16b303] rounded-lg p-5 hover:shadow-xl transition hover:scale-[1.02] ">
...
>
  Installer le Wallet Xaman
          ...
          {/* Étape 2 */}
          <div className="bg-[#202320]/10 text-white shadow-md border-l-4 border-[#16b303] rounded-lg p-5 hover:shadow-xl transition hover:scale-[1.02] ">
