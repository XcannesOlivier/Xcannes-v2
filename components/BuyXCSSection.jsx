...
"
    ...
    CS ?
        ...
        <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 text-left">
          {/* Étape 1 */}
          <div className="bg-[#202320]/40 text-white border-l-4 border-[#16b303] rounded-lg p-5 hover:shadow-xl transition hover:scale-[1.02] ">
...
>
  Installer le Wallet Xaman
          ...
          <div className="bg-[#202320]/40 text-white shadow-md border-l-4 border-[#16b303] rounded-lg p-5 hover:shadow-xl transition hover:scale-[1.02] ">
            <h3 className="text-lg sm:text-xl font-[500] mb-2 bg-[#202320]/40 ">2. Ajoutez la Trustline</h3>
            <p className="mb-4 text-sm">
