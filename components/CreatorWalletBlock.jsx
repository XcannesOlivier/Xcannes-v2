...
export default function CreatorWalletBlock() {
  ...
  return (
    <section
      className="max-w-2xl mx-auto border-[1.5px] border-white border-opacity-30 p-6 rounded-xl mt-10 mb-10 text-center bg-black text-white font-montserrat font-[300]"
    >
      <h2
